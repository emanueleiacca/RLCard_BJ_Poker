...
# Load the DQN agent
file_path = 'C:/Users/emanu/rlcard_copy/experiments/NFSP_TB/Save_Agent/NFSP_checkpoint.pth'
params_file_path= 'optuna_poker_nfsp.json'
#model = NFSPAgent.load_model(file_path,params_file_path)
model = LimitholdemRuleAgentV1()
human_agent = HumanAgent(env.num_actions)
# random_agent = RandomAgent(num_actions=env.num_actions)

# Set the DQN agent as one of the agents in the environment
#model = NFSPAgent(env.num_actions,env.state_shape)
