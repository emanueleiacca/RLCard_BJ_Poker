...
if not os.path.isfile(os.path.join( 'games/doudizhu/jsondata/action_space.txt')) \
        or not os.path.isfile(os.path.join( 'games/doudizhu/jsondata/card_type.json')) \
        or not os.path.isfile(os.path.join( 'games/doudizhu/jsondata/type_card.json')):
    import zipfile
    with zipfile.ZipFile(os.path.join( 'games/doudizhu/jsondata.zip'),"r") as zip_ref:
        zip_ref.extractall(os.path.join( 'games/doudizhu/'))

# Action space
action_space_path = os.path.join( 'games/doudizhu/jsondata/action_space.txt')
...
card_type_path = os.path.join( 'games/doudizhu/jsondata/card_type.json')
with open(card_type_path, 'r') as f:
    data = json.load(f, object_pairs_hook=OrderedDict)
    CARD_TYPE = (data, list(data), set(data))

# a map of type to its cards
type_card_path = os.path.join( 'games/doudizhu/jsondata/type_card.json')
